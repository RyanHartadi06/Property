...
require_once APPPATH . 'third_party/BeforeValidException.php';
require_once APPPATH . 'third_party/ExpiredException.php';
require_once APPPATH . 'third_party/SignatureInvalidException.php';
