					...
					<div class="property-sidebar">
						...
						<div class="like_share_wrap b-0">
							<ul class="like_share_list">
								...
								<li><a href="<?php echo base_url('Home/updatePopuler/'.$d->id_rumah)?>" class="btn btn-likes remove" data-toggle="tooltip" data-original-title="Save"><i class="fas fa-heart"></i>Save</a></li>
							</ul>
						</div>
