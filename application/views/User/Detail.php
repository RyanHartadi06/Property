<div class="clearfix"></div>
			...
			<div class="featured_slick_gallery gray">
				<div class="featured_slick_gallery-slide">
					<div class="featured_slick_padd"><a href="assets/img/pl-1.jpg" class="mfp-gallery"><img src="assets/img/pl-1.jpg" class="img-fluid mx-auto" alt="" /></a></div>
					<div class="featured_slick_padd"><a href="assets/img/pl-2.jpg" class="mfp-gallery"><img src="assets/img/pl-2.jpg" class="img-fluid mx-auto" alt="" /></a></div>
					<div class="featured_slick_padd"><a href="assets/img/pl-3.jpg" class="mfp-gallery"><img src="assets/img/pl-3.jpg" class="img-fluid mx-auto" alt="" /></a></div>
					<div class="featured_slick_padd"><a href="assets/img/pl-4.jpg" class="mfp-gallery"><img src="assets/img/pl-4.jpg" class="img-fluid mx-auto" alt="" /></a></div>
				</div>
			</div>
			<!-- ============================ Hero Banner End ================================== -->
					...
					<div class="row">
						...
						<div class="col-lg-8 col-md-12 col-sm-12">
							...
							<div class="property_block_wrap style-2">
								...
								<div class="property_block_wrap_header">
									<a data-toggle="collapse" data-parent="#amen" href="#clThree" aria-expanded="true"><h4 class="property_block_title">Ameneties</h4></a>
								</div>
							...
							<div class="property_block_wrap style-2">
								...
								<div class="property_block_wrap_header">
									<a data-toggle="collapse" data-parent="#floor" href="#clFive" aria-expanded="true" class="collapsed"><h4 class="property_block_title">Floor Plan</h4></a>
								</div>
								...
								<div id="clSev" class="panel-collapse collapse" aria-expanded="true">
									<div class="block-body">
										<ul class="list-gallery-inline">
											<li>
												<a href="assets/img/pl-1.jpg" class="mfp-gallery"><img src="assets/img/pl-1.jpg" class="img-fluid mx-auto" alt="" /></a>
											</li>
											<li>
												<a href="assets/img/pl-2.jpg" class="mfp-gallery"><img src="assets/img/pl-2.jpg" class="img-fluid mx-auto" alt="" /></a>
											</li>
											<li>
												<a href="assets/img/pl-3.jpg" class="mfp-gallery"><img src="assets/img/pl-3.jpg" class="img-fluid mx-auto" alt="" /></a>
											</li>
											<li>
												<a href="assets/img/pl-4.jpg" class="mfp-gallery"><img src="assets/img/pl-4.jpg" class="img-fluid mx-auto" alt="" /></a>
											</li>
											<li>
												<a href="assets/img/pl-5.jpg" class="mfp-gallery"><img src="assets/img/pl-5.jpg" class="img-fluid mx-auto" alt="" /></a>
											</li>
											<li>
												<a href="assets/img/pl-6.jpg" class="mfp-gallery"><img src="assets/img/pl-6.jpg" class="img-fluid mx-auto" alt="" /></a>
											</li>
										</ul>
									</div>
								</div>
							...
							<div class="property_block_wrap style-2">
								...
								<div class="property_block_wrap_header">
									<a data-toggle="collapse" data-parent="#rev" href="#clEight" aria-expanded="true"><h4 class="property_block_title">102 Reviews</h4></a>
								</div>
							...
							<div class="property_block_wrap style-2">
								...
								<div class="property_block_wrap_header">
									<a data-toggle="collapse" data-parent="#nerby" href="#clNine" aria-expanded="true"><h4 class="property_block_title">Nearby</h4></a>
								</div>
							...
							<div class="property_block_wrap style-2">
								...
								<div class="property_block_wrap_header">
									<a data-toggle="collapse" data-parent="#comment" href="#clTen" aria-expanded="true"><h4 class="property_block_title">Write a Review</h4></a>
								</div>
							...
							<div class="property-sidebar">
								...
								<div class="agent-_blocks_wrap b-0">
									<div class="side-block-header">
										<h3 class="title">Message To Author</h3>
									</div>
									<div class="side-block-body">
										<div class="row">
											...
											<div class="col-lg-12 col-md-12 col-sm-12">
												<div class="stbooking-footer mt-1">
													<div class="form-group mb-0 pb-0">
														<a href="#" class="btn btn-md full-width btn-theme bg-2">Submit Request</a>
													</div>
												</div>
											</div>
										</div>
								...
								<div class="sidebar-widgets">
									...
									<div class="sidebar_featured_property">
										...
										<!-- List Sibar Property -->
										<div class="sides_list_property midium b-0">
											<div class="sides_list_property_thumb">
												<img src="assets/img/indoors/1.jpg" class="img-fluid" alt="">
											</div>
										...
										<div class="sides_list_property midium b-0">
											<div class="sides_list_property_thumb">
												<img src="assets/img/indoors/2.jpg" class="img-fluid" alt="">
											</div>
											<div class="sides_list_property_detail">
										...
										<div class="sides_list_property midium b-0">
											<div class="sides_list_property_thumb">
												<img src="assets/img/indoors/3.jpg" class="img-fluid" alt="">
											</div>
											<div class="sides_list_property_detail">
										...
										<div class="sides_list_property midium b-0">
											<div class="sides_list_property_thumb">
												<img src="assets/img/indoors/4.jpg" class="img-fluid" alt="">
											</div>
											<div class="sides_list_property_detail">
												<h4><a href="single-property-1.html">Lisque Viral Villa</a></h4>
