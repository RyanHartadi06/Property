		...
		<div class="image-cover hero_banner half_banner" style="background:url(<?= base_url()?>global/img/jpeg/banner.png) no-repeat;"
			data-overlay="1">
								...
								<div class="row">
									<div class="col-lg-2 col-md-4 col-sm-4 small-padd">
										<div class="form-group">
											<select class="form-control b-0 b-r" name="category">
									...
									<div class="col-lg-2 col-md-3 col-sm-12 small-padd">
										<div class="form-group">
											<a href="#" class="btn search-btn btn-dark">Cari</a>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="list-slide-box">
							<div class="modern-list">
								<div class="grid-category-thumb">
									<a href="#" class="overlay-cate"><img src="<?= base_url('uploads/rumah/') . $t['banner']; ?>"
								...
								<div class="modern-list-content">
									...
									<div class="listing-footer-wrap property-lists mt-2 d-flex justify-content-center">
										<div class="property-lists d-flex justify-content-center">
											<ul>
												<li><span class="flatcons"><img src="<?= base_url()?>global/img/color-bed.svg"
															alt=""></span><?= $t['jumlah_kamar']?> Bed</li>
												<li><span class="flatcons"><img src="<?= base_url()?>global/img/color-bathroom.svg"
															alt=""></span><?= $t['kamar_mandi']?> Bath</li>
											</ul>
										</div>
									</div>
								</div>
				...
				<div class="row">
					<?php foreach($populer as $p){?>
						...
						<div class="list-slide-box">
							<div class="modern-list">
								<div class="grid-category-thumb">
									<a href="#" class="overlay-cate"><img src="<?= base_url('uploads/rumah/') . $p['banner']; ?>"
											class="img-responsive" alt=""></a>
									<div class="property_meta simple">
								...
								<div class="modern-list-content">
									...
									<div class="listing-footer-wrap property-lists mt-2 d-flex justify-content-center">
										<div class="property-lists d-flex justify-content-center">
											<ul>
												<li><span class="flatcons"><img src="<?= base_url()?>global/img/color-bed.svg"
															alt=""></span><?= $p['jumlah_kamar']?> Bed</li>
												<li><span class="flatcons"><img src="<?= base_url()?>global/img/color-bathroom.svg"
															alt=""></span><?= $p['kamar_mandi']?> Bath</li>
											</ul>
										</div>
									</div>
								</div>
