									...
									<div class="single_property_style property_style_2 modern">
										...
										<div class="listing_thumb_wrapper">
											<div class="property_gallery_slide-thumb">
												<a href="single-property-1.html"><img src="<?= base_url('uploads/rumah/') . $l->banner; ?>" class="img-fluid mx-auto" alt=""></a>
											</div>
										</div>
										...
										<div class="modern_property_footer">
											<div class="property-lists flex-1">
												<ul>
												<li><span class="flatcons"><img src="<?= base_url() ?>global/img/bed.svg" alt=""></span><?= $l->jumlah_kamar; ?> Beds</li>
												<li><span class="flatcons"><img src="<?= base_url() ?>global/img/bath.svg" alt=""></span><?= $l->kamar_mandi; ?> Baths</li>
												</ul>
											</div>
											<div class="fp_types">
												<?php 
												if($l->status_property == 1) { ?>
												Jual
												<?php } else { ?>
												Sewa
												<?php } ?>
