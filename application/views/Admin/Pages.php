                ...
                <tbody> 
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url("Pages/edit/" .$row['id']);?>"
                                class="btn btn-sm btn-success btn-circle">
                                <i class="fas fa-pen"></i>
                                </a>
                                <!-- <a href="<?php echo base_url("Agency/hapus/" .$row['id']);?>"
                                class="btn btn-sm btn-danger btn-circle">
                                <i class="fas fa-trash"></i>
                                </a> -->
                                <a href="<?php echo base_url('Pages/hapus/' . $row['id']) ?>"
                                    onclick="confirm_modal('<?php echo 'Pages/hapus/' . $row['id']; ?>')"
