  ...
  <div class="container-fluid">
      ...
      <div class="card shadow mb-4">
          <div class="card-body">
              ...
              <form method="POST" action="<?= base_url('Slider/editdata')?>" enctype="multipart/form-data">
                  <div class="form-group">
                      <label for="exampleEmail">Slider</label>
                      <?php foreach($data as $d){?>
                         <input type="text" class="form-control mb-3" id="id" name="id" value="<?= $d['id_slide']?>" hidden/>
                      <?php } ?>
