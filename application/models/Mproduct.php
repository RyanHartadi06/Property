...
class Mproduct extends CI_Model
{
    ...
    public function make_query($minimum_price, $maximum_price, $properti, $kasur, $kamar_mandi, $status_properti)
    {
        $query = "
  SELECT * FROM rumah
  WHERE status = '1'
  ";
   ...
   ";
    ...
    public function count_all($minimum_price, $maximum_price, $properti, $kasur, $kamar_mandi, $status_properti)
    {
    ...
    public function fetch_data($limit, $start, $minimum_price, $maximum_price, $properti, $kasur, $kamar_mandi, $status_properti)
    {
        $query = $this->make_query($minimum_price, $maximum_price, $properti, $kasur, $kamar_mandi, $status_properti);
									...
									<div class="single_property_style property_style_2 modern">
										...
										<div class="modern_property_footer">
											<div class="property-lists flex-1">
												<ul>
													<li><span class="flatcons"><img src="https://kumarpreet.com/verio-demo/assets/img/bed.svg" alt=""></span>' . $row['jumlah_kamar'] . ' Kamar</li>
													<li><span class="flatcons"><img src="https://kumarpreet.com/verio-demo/assets/img/bath.svg" alt=""></span>' . $row['kamar_mandi'] . ' Kamar Mandi</li>
												</ul>
											</div>
